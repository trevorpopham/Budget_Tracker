...
(function (global, factory) {
  ...
  var DropdownUI = /** @class */ (function () {
      ...
      DropdownUI.prototype.clear = function () {
          var $parent = $('.note-btn-household.open');
  ...
  $(document).on('click', function (e) {
      if (!$(e.target).closest('.note-btn-household').length) {
          $('.note-btn-household.open').removeClass('open');
      }
  });
  ...
  var buttonGroup = renderer.create('<div class="note-btn-household">');
      ...
      return buttonGroup({
          ...
          children: [
              ...
              dropdown({
                  items: [
                      '<div>',
                      '<div class="note-btn-household btn-background-color">',
                      ...
                      '  </div>',
                      '</div>',
                      '<div class="note-btn-household btn-foreground-color">',
  ...
  var videoDialog = function (opt) {
      var body = '<div class="note-form-household">' +
  ...
  var imageDialog = function (opt) {
      var body = '<div class="note-form-household note-household-select-from-files">' +
          ...
          opt.imageLimitation +
          '</div>' +
          '<div class="note-form-household" style="overflow:auto;">' +
  ...
  */
  ...
  var Buttons = /** @class */ (function () {
      ...
      Buttons.prototype.build = function ($container, household's) {
          for (var groupIdx = 0, groupLen = household's.length; groupIdx < groupLen; groupIdx++) {
              var household = household's[groupIdx];
              var householdName = Array.isArray(household) ? household[0] : household;
              var buttons = Array.isArray(household) ? ((household.length === 1) ? [household[0]] : household[1]) : [household];
              var $household = this.ui.buttonGroup({
                  className: 'note-' + householdName
              }).render();
              for (var idx = 0, len = buttons.length; idx < len; idx++) {
                  var btn = this.context.memo('button.' + buttons[idx]);
                  if (btn) {
                      $household.append(typeof btn === 'function' ? btn() : btn);
                  }
              }
              $household.appendTo($container);
          }
      };
      /**
  ...
  var LinkDialog = /** @class */ (function () {
      ...
      LinkDialog.prototype.initialize = function () {
          ...
          var body = [
              '<div class="form-household note-form-household">',
  ...
  var ImageDialog = /** @class */ (function () {
      ...
      ImageDialog.prototype.initialize = function () {
          ...
          var body = [
              '<div class="form-household note-form-household note-household-select-from-files">',
              '<label class="note-form-label">' + this.lang.image.selectFromFiles + '</label>',
              '<input class="note-image-input form-control-file note-form-control note-input" ',
              ' type="file" name="files" accept="image/*" multiple="multiple" />',
              imageLimitation,
              '</div>',
              '<div class="form-household note-household-image-url" style="overflow:auto;">',
  ...
  var VideoDialog = /** @class */ (function () {
      ...
      VideoDialog.prototype.initialize = function () {
          var $container = this.options.dialogsInBody ? this.$body : this.$editor;
          var body = [
              '<div class="form-household note-form-household row-fluid">',
  ...
  var HintPopover = /** @class */ (function () {
      ...
      HintPopover.prototype.moveDown = function () {
          ...
          if ($next.length) {
              ...
              if (!$nextGroup.length) {
                  $nextGroup = this.$content.find('.note-hint-household').first();
              }
      ...
      HintPopover.prototype.moveUp = function () {
          ...
          if ($prev.length) {
              ...
              if (!$prevGroup.length) {
                  $prevGroup = this.$content.find('.note-hint-household').last();
              }
      ...
      HintPopover.prototype.createGroup = function (idx, keyword) {
          var _this = this;
          var $household = $$1('<div class="note-hint-household note-hint-household-' + idx + '"/>');
          this.searchKeyword(idx, keyword, function (items) {
              items = items || [];
              if (items.length) {
                  $household.html(_this.createItemTemplates(idx, items));
                  _this.show();
              }
          });
          return $household;
          ...
          if (!lists.contains([key.code.ENTER, key.code.UP, key.code.DOWN], e.keyCode)) {
              ...
              if (this.hints.length && keyword_1) {
                  ...
                  if (bnd) {
                      ...
                      // set position for popover after household is created
